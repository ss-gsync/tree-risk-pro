 ...
 */
export const useGoogleMapsApi = (apiKey, libraries = ['marker', 'geometry'], enableWebGL = true) => {
      ...
      googleMapsPromise = new Promise((resolve, reject) => {
        window.googleMapsInitialized = () => {
          ...
          setTimeout(() => {
            ...
            // Dispatch custom event to notify components waiting for Google Maps
            console.log('Dispatching mapsApiInitialized event');
            window.dispatchEvent(new CustomEvent('mapsApiInitialized', {
