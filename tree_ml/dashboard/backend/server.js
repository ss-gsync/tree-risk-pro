...
// Serve ML data directory from the correct location
// This serves files from /ttt/data when requested at /ttt/data path
app.use('/ttt/data', express.static('/ttt/data'));
